// Slide
let list = document.querySelector('.container__slide-main--run .container__slide-main-list')
let items = document.querySelectorAll('.container__slide-main--run .container__slide-main-list .container__slide-main--iteam')
let dots = document.querySelectorAll('.container__slide-main--run .container__slide-main-dots li')
...
let nextSlide = setInterval(() => { next.click() }, 5000)

function reloadSlide() {
    let checkLeft = items[active].offsetLeft
    list.style.left = -checkLeft + 'px'

    let lastActiveDot = document.querySelector('.container__slide-main--run .container__slide-main-dots li.container__slide-main-dots--active')
    lastActiveDot.classList.remove('container__slide-main-dots--active')
    dots[active].classList.add('container__slide-main-dots--active')

    clearInterval(nextSlide)
    nextSlide = setInterval(() => { next.click() }, 5000)
}
...
function listPage() {
    ...
    document.querySelector('.pagination home-product__pagination').innerHTML = ''
