        ...
        <div class="grid">
            ...
            <div class="card__product">
                ...
                <div class="card__product-right">
                    <div class="card__product-right-nameproduct">Quần Ống Rộng Uniex - Quần Jogger fomr rộng phối 3 sọc
                        trẻ trung chất mịn không xù</div>
                    <div class="card__product-right-price">
                        <div class="card__product-right-pricecurrent"><sup>₫</sup>114.000</div>
                        <div class="card__product-right-priceold"><sup>₫</sup>114.000</div>
                        <div class="card__product-right-pricesale">-33%</div>
                    </div>
                    <div class="card__product-right-description">
                        <h3 class="card__product-right-descriptionpro">
                            Mô tả sản phẩm :
                        </h3>
                        <h3 class="card__product-right-descriptionpro">
                            - Vải nhung tăm cao cấp dày dặn, mặc được quanh năm
                        </h3>
                    </div>
                    <div class="card__product-right-option">
                        <div class="card__product-right-container">
                            <h3 class="card__product-right-heading">Màu Sắc</h3>
                            <div class="card__product-right-optiontype">
                                <button class="card__product-right-optioncolor">Đen</button>
                                <button class="card__product-right-optioncolor">Trắng</button>
                            </div>
                        </div>
                        <div class="card__product-right-container">
                            <h3 class="card__product-right-heading">Size</h3>
                            <div class="card__product-right-optiontype">
                                <button class="card__product-right-optioncolor">M</button>
                                <button class="card__product-right-optioncolor">L</button>
                                <button class="card__product-right-optioncolor">XL</button>
                            </div>
                        </div>
                        <div class="card__product-right-container">
                            <h3 class="card__product-right-heading">Số Lượng</h3>
                            <div class="card__product-right-optiontype">
                                <button class="card__product-right--minus"><svg enable-background="new 0 0 10 10"
                                        viewBox="0 0 10 10" x="0" y="0">
                                        <polygon points="4.5 4.5 3.5 4.5 0 4.5 0 5.5 3.5 5.5 4.5 5.5 10 5.5 10 4.5">
                                        </polygon>
                                    </svg></button>
                                <input type="text" value="1" class="card__product-right--input">
                                <button class="card__product-right--plus"><svg enable-background="new 0 0 10 10"
                                        viewBox="0 0 10 10" x="0" y="0">
                                        <polygon
                        ...
                        <div class="card__product-right-function">
                            <input type="submit" value="Thêm Vào Giỏ Hàng" alt="" class="card__product-right-addcart">
                            <input type="submit" value="Mua Ngay" alt="" class="card__product-right-buynow">
                        </div>
                    </div>
                </div>
            </div>
