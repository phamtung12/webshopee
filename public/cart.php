            ...
            <nav class="navbar">
                <div class="home-box">
                    <a href="/" class="shopee-home">
                        <svg viewBox="0 0 192 65" height="46px" width="130px">
                            <g fill-rule="evenodd">
                                <path fill="#ee4d2d"
                    ...
                    <div class="login-text">Giỏ hàng</div>
                </div>
        ...
        <div class="grid">
            <div class="cart__container">
                <div class="cart__header">
                    <div class="cart__header-checkbox">
                        <input type="checkbox">
                    </div>
                    <div class="cart__header-product">Sản Phẩm</div>
                    <div class="cart__header-price">Đơn Giá</div>
                ...
                <div class="cart__item">
                    ...
                    <a href="" class="cart__item-product">
                        <img src="./assets/img/dongho.jpg" alt="Sản phẩm" class="cart__item-product-img">
                        <div class="cart__item-nameproduct">
                            GOOJODOQ Đồng hồ thông minh màn hình cảm ứng mờ 1.43 &quot; | Tập thể dục | Tương thích với
                            IOS & Android | Đồng hồ thông minh Bluetooth Fitness
                        </div>
                    </a>
                    <div class="cart__item-type">
                    </div>
                    <div class="cart__item-price">
                        <div class="cart__item-price--old"><sup>đ</sup>800.000 </div>
                        <div class="cart__item-price--current"><sup>đ</sup>529.000</div>
                    </div>
                    <div class="cart__item-quantity">
                        <button class="cart__item-quantity--minus"><svg enable-background="new 0 0 10 10"
                                viewBox="0 0 10 10" x="0" y="0">
                                <polygon points="4.5 4.5 3.5 4.5 0 4.5 0 5.5 3.5 5.5 4.5 5.5 10 5.5 10 4.5"></polygon>
                            </svg></button>
                        <input type="text" value="1" class="cart__item-quantity--input">
                        <button class="cart__item-quantity--plus"><svg enable-background="new 0 0 10 10"
                                viewBox="0 0 10 10" x="0" y="0">
                                <polygon
                    ...
                    <div class="cart__item-totalprice">529.000đ</div>
                    <a href="" class="cart__item-remove">Xóa</a>
                </div>
                <div class="cart__footer">
                    <div class="cart__footer-checkbox">
                        <input type="checkbox">
                    </div>
                    <div class="cart__footer-allproduct">Chọn Tất Cả (1)</div>
                    <a href="" class="cart__footer-remove">Xóa</a>
                    <a href="" class="cart__footer-myfavourite">Lưu vào mục Đã thích</a>
                    <div class="cart__footer-type"></div>
                    <div class="cart__footer-totalprice">
                        <div class="cart__footer-pay">Tổng thanh toán (1 Sản phẩm):</div>
                        <div class="cart__footer-price"><sup>đ</sup>529.000</div>
                    </div>
                    <input type="submit" value="Mua Hàng" class="cart__footer-buy-btn">
                </div>
            </div>
        </div>
    </main>
